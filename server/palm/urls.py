...
urlpatterns = [
    ...
    path("groups/<int:group_id>/", device_groups.members.index, name="individual_device_groups"),
    path("groups/<int:group_id>/<str:entity_id>", device_groups.members_manage.index, name="Group_member_management")
]
