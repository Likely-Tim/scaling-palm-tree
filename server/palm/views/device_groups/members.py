...
from palm.models import DeviceGroupMembers, DeviceGroup
...
def index(request, group_id):
    if request.method == "POST":
        ...
        groups_entities_data = list(group_entities.values('group_id', 'entity_id'))
        result = {"group": model_to_dict(group), "entities": groups_entities_data}
